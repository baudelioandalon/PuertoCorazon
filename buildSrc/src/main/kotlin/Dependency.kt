object Dependency {
    ...
    const val navigationFragmentKtx = "androidx.navigation:navigation-fragment-ktx:${Version.navigationFragmentVersion}"
    const val navigationUiKtx = "androidx.navigation:navigation-ui-ktx:${Version.navigationUiVersion}"
    const val navigationRuntimeKtx = "androidx.navigation:navigation-runtime-ktx:${Version.navigationRuntime}"
    const val kotlinxCoroutinesCore = "org.jetbrains.kotlinx:kotlinx-coroutines-core:${Version.coroutineCoreVersion}"
    ...
    const val playServicesAuth = "com.google.android.gms:play-services-auth:${Version.googleServicesVersion}"
    ...
    const val pluginSageArgs = "androidx.navigation:navigation-safe-args-gradle-plugin:${Version.safeArgsVersion}"
    ...
    const val pluginGmsGoogleServices = "com.google.gms:google-services:${Version.gmsGoogleServicesVersion}"

    const val lottie =  "com.airbnb.android:lottie:${Version.lottieVersion}"
    const val roundableImageView =  "com.makeramen:roundedimageview:${Version.roundableImageViewVersion}"
    ...
    const val lifecycleRuntime = "androidx.lifecycle:lifecycle-runtime-ktx:${Version.lifecycleRuntimeVersion}"
    const val lifecycleExtensions = "android.arch.lifecycle:extensions:${Version.lifecycleExtensionsVersion}"
    const val activityKtx = "androidx.activity:activity-ktx:${Version.activityKtxVersion}"
    const val lifecycleKtx = "androidx.lifecycle:lifecycle-livedata-ktx:${Version.lifecycleKtxVersion}"

    //DESIGN
    const val circularProgress = "com.jackandphantom.android:circularprogressbar:${Version.circularProgressVersion}"
    const val realtimeBlurView = "com.github.mmin18:realtimeblurview:${Version.realtimeBlurViewVersion}"
    ...
    const val glideCompilerLibrary = "com.github.bumptech.glide:compiler:${Version.glideLibraryVersion}"
    ...
    const val firebaseCrashlyticsKtx = "com.google.firebase:firebase-crashlytics-ktx:${Version.firebaseCrashlytics}"
    const val firebaseAuth = "com.google.firebase:firebase-auth:${Version.firebaseAuthVersion}"
    const val firestoreKtx = "com.google.firebase:firebase-firestore-ktx:${Version.firestoreKtxVersion}"
    const val firestoreStorage = "com.google.firebase:firebase-storage:${Version.firestoreStorageVersion}"
    ...
    const val squareupRetrofit = "com.squareup.retrofit2:retrofit:${Version.squareupRetrofitVersion}"
    const val squareupGson = "com.squareup.retrofit2:converter-gson:${Version.squareupGsonConverterVersion}"
    const val squareupLogging = "com.squareup.okhttp3:logging-interceptor:${Version.squareupLoggingVersion}"

    //Google Maps
    const val serviceMap = "com.google.android.gms:play-services-maps:${Version.serviceMapVersion}"
    const val serviceLocation = "com.google.android.gms:play-services-location:${Version.serviceLocationVersion}"
    const val placesLibrary = "com.google.android.libraries.places:places:${Version.placesLibraryVersion}"

    const val rxJava2Adapter = "com.squareup.retrofit2:adapter-rxjava2:${Version.rxJava2AdapterVersion}"
    const val keyboardVisibility = "net.yslibrary.keyboardvisibilityevent:keyboardvisibilityevent:${Version.keyboardVisibilityVersion}"

    //Injection Dependencies
    const val dagger2 = "com.google.dagger:dagger:${Version.dagger2Version}"
    const val dagger2Compiler = "com.google.dagger:dagger-compiler:${Version.dagger2CompilerVersion}"

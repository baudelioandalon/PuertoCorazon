...
abstract class AFirestoreRepository {
    ...
    protected fun errorResponse(exception: FirebaseFirestoreException): CUFirestoreErrorEnum {
    ...
    protected fun validationError(errorReceived: String): CUFirestoreErrorEnum {
        return when {
